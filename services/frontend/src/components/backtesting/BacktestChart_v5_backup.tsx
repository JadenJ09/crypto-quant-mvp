...
const BacktestChart: React.FC<BacktestChartProps> = memo(({
    ...
    useEffect(() => {
        ...
        const chart = createChart(chartContainerRef.current, {
            ...
            height: totalChartHeight, // Dynamic height based on indicators
            layout: {
                ...
                panes: {
                    ...
                    enableResize: false, // Disable user resizing to maintain consistent heights
                },
            },
            grid: {
    ...
    return (
        <div 
            ...
            className="w-full rounded-md border border-gray-200 dark:border-gray-800 chart-container"
